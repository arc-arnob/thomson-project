...
<html>
	...
	<body>
		...
		<a class="navbar-brand" href="#">Issue Register</a>
		...
		<div id="info" class="container">
			<h5>This is Issue register, please press CTRL+F to find anything in the table.</h5>
		</div>
		<?php
		...
		echo "<th scope='col'>AMOUNT ISSUED</th>";
		...
		while($row=mysqli_fetch_array($result)){  
			echo "<tbody>";
			echo "<tr><td>" . $row['ITEM_CD'] . "</td><td>" . $row['AMOUNT_ISSUED'] . "</td><td>" . $row['ISSUE_DATE'] . "</td></tr>" ; 
			echo "</tbody>";
		}
		echo "</table>";
		}else{
